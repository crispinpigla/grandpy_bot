...
expectedvalue_test_recherche_api_gmaps = {'results':[{'formatted_address':'10 Quai de la Charente, 75019 Paris, France'}]}
...
expectedvalue_test_recherche_api_wiki = {'query': { 'pages': {'123':{'extract':'quai de la Charente est un quai situé le long du canal Saint-Denis, à Paris, dans le 19eme arrondissement.'}} } }
