...
PRESENTATION_RESPONSE = [
    "J'ai {{i}} résultat(s), voici !",
    "Voici {{i}} résultat(s) que j'ai trouvé !",
    "J'ai trouvé {{i}} résultat(s) !",
    "Voici, j'ai repéreré {{i}} résultat(s) !",
]
ANNONCE_DESCRIPTION_RESPONSE = [
    "Mais t'ai-je déjà raconté l'histoire de ",
    "Voici une petite histoire sur ",
    "Veux tu que je te parle de ",
    "Connais-tu la petite histoire de "
]
